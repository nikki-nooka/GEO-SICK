...
import type { PrescriptionAnalysisResult, User } from '../types';
...
export const PrescriptionAnalysisPage: React.FC<PrescriptionAnalysisPageProps> = ({ user, onBack }) => {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      setAnalysis(result);
      addHistoryEvent(user.nickname, 'prescription_analysis', { result });
    } catch (err) {
      console.error(err);
