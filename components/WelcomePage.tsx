...
import { GlobeIcon, LogoutIcon, ScanIcon, ClipboardListIcon, NewspaperIcon, BrainCircuitIcon, StethoscopeIcon, HistoryIcon } from './icons';
...
export const WelcomePage: React.FC<WelcomePageProps> = ({ user, onAnalyze, onLogout, onAnalyzePrescription, onAnalyzeMentalHealth, onCheckSymptoms, onViewHistory }) => {
                ...
                <div className="bg-white/60 backdrop-blur-xl rounded-2xl shadow-2xl p-8 sm:p-12 animate-fade-in-up">
                    ...
                    <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <button
                            ...
                            className="bg-teal-500 hover:bg-teal-600 text-white font-semibold py-3 px-6 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-teal-300"
                            aria-label="Check your symptoms"
                        >
                         ...
                         <button
                            ...
                            className="bg-indigo-500 hover:bg-indigo-600 text-white font-semibold py-3 px-6 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-indigo-300"
                            aria-label="Take a mental wellness check"
                        >
                        ...
                        >
                         ...
                         <button
                            ...
                            className="bg-slate-500 hover:bg-slate-600 text-white font-semibold py-3 px-6 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-slate-300"
                            aria-label="View your activity history"
                        >
