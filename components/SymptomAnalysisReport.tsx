...
import { SummaryIcon, HazardIcon, ShieldCheckIcon, StethoscopeIcon, DiseaseIcon } from './icons';
...
export const SymptomAnalysisReport: React.FC<SymptomAnalysisReportProps> = ({ result }) => {
  return (
